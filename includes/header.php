...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
	  <a class="navbar-brand" href="index.php">ML Classification</a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
	    <ul class="navbar-nav ml-auto">
	      <li class="nav-item">
	        <a class="nav-link " href="regression.php"><b>Linear Regression</b></a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="dt.php"><b>Decision Tree</b></a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="svm.php"><b>SVM</b></a>
	      </li>
	    </ul>
	  </div>
	</nav>